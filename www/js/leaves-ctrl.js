(function() {
    ...
    angular.module('datepickerapp').controller('LeavesCtrl', ['$scope', '$rootScope','Leaves', 'AuthenticationService', LeavesCtrl]);

        function LeavesCtrl($scope, $rootScope, Leaves, AuthenticationService) {
            var vm = this;
        ...
        */
            console.log('Inside LeavesCtrl :');
            vm.userProfile = AuthenticationService.getUserProfile();               
            console.log('Inside LeavesCtrl :'+vm.userProfile);
